    		...
    		<>
	    		...
	    		<section className="section pt-5 pb-5">
                     ...
                     <Row>
                           ...
                           Welcome to our website. If you continue to browse and use this website you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern <span className="brand-title">MAAROOS's</span> relationship with you in relation to this website.<br/>
                           The term <span className="brand-title">'MAAROOS'</span> or 'us' or 'we' refers to the owner of the website whose registered/operational office is FNo: T2, Sai Triambakkam Flats, Lakshmi Nagar Main Road, Plot No: 11, Madipakkam. Kanchipuram TAMIL NADU 600091. The term 'you' refers to the user or viewer of our website.<br/>
                           ...
                           -- You may not create a link to this website from another website or document without <span className="brand-title">MAAROOS's</span> prior written consent.<br/>
